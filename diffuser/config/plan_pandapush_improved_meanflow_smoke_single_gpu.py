"""Single-batch Isaac Gym planning check for the iMF smoke checkpoint."""
...
mode_to_args = {
    "dlp": {
        ...
        "horizon": 5,
        "device": "cuda:0",
        "diffusion_loadpath": "improved_meanflow_smoke_mb8/3C_dlp_adalnpint_randcolor_H5_T4_seed42",
...
base = {
    "plan": {
        ...
        "loadbase": loadbase,
        "logbase": logbase,
        "prefix": "improved_meanflow_smoke_plans/",
