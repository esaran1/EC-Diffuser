...
def main():
    ...
    payload = {
        ...
        "effective_config_sha256_note": (
            "Hashes the 47 resolved config keys with native types. The preflight "
            "document quoted b33683244bd6f8d6, which hashed a 48-key dict that "
            "additionally carried the bookkeeping key _results_folder and coerced "
            "every value to str. Verified key-by-key: the two dicts differ only by "
            "_results_folder, and all 27 scientific invariants are identical."),
        "command": ("cd /home/jren313/ecdiff-seed44-7506ce48 && "
        ...
        "prospective_endpoint": {
            ...
            "status": ("prospective with respect to seed 44; derived from "
